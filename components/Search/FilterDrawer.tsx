  ...
  return (
    <Drawer open={open} onOpenChange={handleOpenChange}>
      ...
      <DrawerContent className="max-h-[85vh]">
        ...
        <div className="flex flex-col gap-6 p-5 overflow-y-auto">
          ...
          <section>
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <span className="text-muted-foreground">-</span><div className="flex-1 flex items-center gap-2 rounded-lg border border-input bg-input/20 px-3 py-1">
                <span className="text-muted-foreground">Q</span>
                <Input
                  type="number"
                  min={PRICE_MIN}
        ...
        <DrawerFooter className="flex flex-row gap-2.5 border-t border-border p-5">
          <Button
            size="xl"
            variant="outline"
